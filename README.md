...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-quality` self).
...
- Public extensions exposed by this project: `FlextQualityBaseReporter`, `FlextQualityDocumentationDashboard`, `FlextQualityValidationSettings`, `FlextQualityDocumentationOptimizer`, `FlextQualityRulesEngine`, `FlextQualityTypes` (+32 more).
