...
class Command(BaseCommand):
    ...
    def handle(self, *_args, **options) -> None:
        self.stdout.write(self.style.SUCCESS("🚀 Populating backend and issue type data..."),
        )
        ...
        self.stdout.write(self.style.SUCCESS("✅ Backend and issue type data populated successfully!",
            ),
        )

    def _create_backends(self, force_update) -> None:
        backends_data = [{"name": "ast",
                "display_name": "AST Analyzer",
                "description":
                    "Python Abstract Syntax Tree analysis for structural code analysis",
                "capabilities":
            ["class_analysis",
                    "function_analysis",
                    "variable_analysis",
            ...
            {"name": "external",
                ...
                "description": "Integration with external security and quality tools (bandit, vulture)",  # TODO:
                    Break long line
            ...
            {"name": "quality",
                ...
                "description": "Code quality metrics using radon (complexity, maintainability, Halstead)",  # TODO: Break long line
        ...
        for backend_data in backends_data:
            backend, created = AnalysisBackendModel.objects.get_or_create(name=backend_data["name"],
    ...
    def _create_issue_types(self, force_update) -> None:
        ...
        issue_types_data = [# AST Backend Issues
            {"backend":
            ast_backend,
                "code": "AST001",
                ...
                "severity": "LOW",
                "recommendation":
                    "Add a docstring to document the class purpose and usage",
            },
            {"backend":
        ast_backend,
                "code": "AST002",
                ...
                "category": "documentation",
                "severity": "LOW",
                "recommendation": "Add a docstring to document function parameters and return value",  # TODO: Break long line
            },
            {"backend": ast_backend,
                "code": "AST003",
                ...
                "category": "complexity",
                "severity": "MEDIUM",
                "recommendation": "Consider breaking down the function into smaller, simpler functions",  # TODO: Break long line
            },
            {"backend": ast_backend,
                "code": "AST004",
                ...
                "category": "quality",
                "severity": "MEDIUM",
                "recommendation": "Consider using data classes or parameter objects to reduce parameter count",  # TODO: Break long line
            },
            {"backend": ast_backend,
                "code": "AST005",
                "name": "Deep Inheritance",
                "description":
                    "Class with deep inheritance hierarchy",
                "category": "maintainability",
                "severity": "MEDIUM",
                "recommendation": "Consider composition over inheritance or flattening the hierarchy",  # TODO: Break long line
            },
            # External Tools Issues (Bandit Security)
            {"backend": external_backend,
                "code": "B101",
                "name": "Use of assert detected",
                "description": "Assert statements are removed when compiling to optimized byte code",  # TODO: Break long line
                "category": "security",
                "severity": "LOW",
                "recommendation": "Use explicit exception raising instead of assert for production code",  # TODO:
            Break long line
                "documentation_url": "https://bandit.readthedocs.io/en/latest/plugins/b101_assert_used.html",  # TODO: Break long line
            },
            {"backend": external_backend,
                "code": "B102",
                "name":
             ...
             "Use of exec detected",
                ...
                "documentation_url": "https://bandit.readthedocs.io/en/latest/plugins/b102_exec_used.html",  # TODO: Break long line
            },
            {"backend": external_backend,
                "code": "B103",
            ...
            {"backend": external_backend,
                ...
                "documentation_url": "https://bandit.readthedocs.io/en/latest/plugins/b301_pickle.html",  # TODO: Break long line
            },
            {"backend": external_backend,
                "code": "B401",
                ...
                "documentation_url":
             "https://bandit.readthedocs.io/en/latest/plugins/b401_import_telnet.html",  # TODO: Break long line
            },
            {"backend": external_backend,
                "code": "B501",
                "name":
            ...
            {"backend": external_backend,
                ...
                "category": "dead_code",
                "severity": "LOW",
                "recommendation": "Remove unused variable or prefix with underscore if intentionally unused",  # TODO:
            Break long line
            },
            {"backend": external_backend,
                "code": "V003",
            ...
            {"backend": external_backend,
                ...
                "severity": "MEDIUM",
                "recommendation":
                    "Remove unused class or ensure it's being used properly",
            },
        ...
        quality_backend,
                ...
                "category": "complexity",
                "severity": "HIGH",
                "recommendation": "Refactor function to reduce complexity by breaking it into smaller functions",  # TODO: Break long line
            },
            {"backend": quality_backend,
                ...
                "category": "quality",
                "severity": "MEDIUM",
                "recommendation": "Consider breaking class into smaller classes or using composition",  # TODO:
        Break long line
            },
            {"backend": quality_backend,
                "code": "R903",
            ...
            {"backend": quality_backend,
                ...
                "category": "maintainability",
                "severity": "MEDIUM",
                "recommendation": "Improve code quality by reducing complexity and adding documentation",  # TODO: Break long line
            },
            {"backend": quality_backend,
                "code": "H001",
        ...
        for issue_data in issue_types_data:
            issue_type, created = IssueType.objects.get_or_create(backend=issue_data["backend"],
