"""Initial migration for analyzer Django app.

This migration creates the initial database schema for the code analysis models.
"""
...
class Migration:
    """Initial migration for analyzer app."""
