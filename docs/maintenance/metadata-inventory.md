...
| external-meltano-native | `external-meltano-native/docs/maintenance` | `config.yaml` | `README.md` | _(shared runner invoked via Makefile)_ | Added first-class config + Makefile target powered by shared runner. |
