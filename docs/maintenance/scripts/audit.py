...
class DocumentationAuditor:
    ...
    def _check_outdated_indicators(self, content: str) -> FlextCore.Types.StringList:
    ...
    def _check_markdown_formatting(self, content: str) -> FlextCore.Types.StringList:
    ...
    def _check_heading_hierarchy(self, content: str) -> FlextCore.Types.StringList:
