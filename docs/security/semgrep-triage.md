...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 626 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-quality.json`
