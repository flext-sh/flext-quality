...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-quality — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:626`
...
```toml
      622  all = true
      623  in_place = true
      624  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      625  
>>>   626  [tool.uv]
      627  link-mode = "copy"
      628  
      629  [tool.vulture]
      630  exclude = ["*/_protocols/*"]
```
