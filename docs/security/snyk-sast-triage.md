...
|---|---|---|---|---|---|---|
| 1 | medium | Jinja auto-escape is set to false. | `src/flext_quality/docs/scripts/report.py` | 385 | - | |
...
Dados brutos: `~/snyk-violations/sast/flext-sh__flext-quality.sast.json`
