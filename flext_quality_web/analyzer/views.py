...
def health_check(request):
    ...
    return JsonResponse({"status": "healthy", "service": "analyzer"})
...
class AnalysisSessionSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        model = AnalysisSession
        fields = ["id", "name", "status", "created_at", "overall_score"]
...
def analysis_session_detail(request: HttpRequest, session_id: int) -> HttpResponse:
    ...
    duplicate_blocks = session.duplicate_code_blocks.order_by("-similarity_score")
