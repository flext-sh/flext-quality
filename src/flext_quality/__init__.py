...
_LAZY_IMPORTS: Mapping[str, tuple[str, str]] = {
    ...
    "FlextQualityReportData": ("flext_quality.docs.scripts.report", "FlextQualityReportData"),
    ...
    "FlextQualityTrendData": ("flext_quality.docs.scripts.report", "FlextQualityTrendData"),
