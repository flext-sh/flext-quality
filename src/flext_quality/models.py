...
class FlextQualityModels(FlextWebModels, FlextCliModels):
    ...
    class Quality:
        ...
        class Issue(BaseModel):
            ...
            type: Annotated[str, Field(description="Issue type identifier")]
            severity: Annotated[str, Field(description="Severity level identifier")]
            file: Annotated[str, Field(description="File path where issue was found")]
            line: Annotated[
                int | None,
                Field(default=None, description="Issue line number"),
            ]
            description: Annotated[
                str,
                Field(default="", description="Issue description"),
            ]
            recommendation: Annotated[
                str,
                Field(default="", description="Recommended fix"),
            ]
            context: Annotated[
        ...
        class ValidationResult(BaseModel):
            ...
            valid_items: Annotated[int, Field(default=0)]
            invalid_items: Annotated[int, Field(default=0)]
            issues: Annotated[
                MutableSequence[FlextQualityModels.Quality.Issue],
                Field(
                    default_factory=list,
                ),
            ]
            warnings: Annotated[MutableSequence[str], Field(default_factory=list)]
            errors: Annotated[MutableSequence[str], Field(default_factory=list)]
            metadata: Annotated[
                MutableMapping[str, t.Primitives],
        ...
        class ScheduleTaskConfig(BaseModel):
            ...
            description: str
            command: str
            timeout: Annotated[t.PositiveInt, Field(default=300)]
        ...
        class ScheduleEntry(BaseModel):
            ...
            enabled: bool = True
            time: str
            tasks: Annotated[t.StrSequence, Field(default_factory=list)]
            day: str | None = None
        ...
        class ErrorHandlingConfig(BaseModel):
            ...
            retry_delay: Annotated[t.NonNegativeInt, Field(default=60)]
        ...
        class LoggingConfig(BaseModel):
            ...
            retention_days: Annotated[t.PositiveInt, Field(default=30)]
        ...
        class AuditRecommendation(BaseModel):
            ...
            category: str
            recommendation: str
            actions: Annotated[t.StrSequence, Field(default_factory=list)]
        ...
        class AuditorResults(BaseModel):
            ...
            metrics: Annotated[
                FlextQualityModels.Quality.AuditMetrics,
                Field(
                    default_factory=lambda: FlextQualityModels.Quality.AuditMetrics(),
                ),
            ]
            recommendations: Annotated[
                MutableSequence[FlextQualityModels.Quality.AuditRecommendation],
                Field(default_factory=list),
            ]
        ...
        class LinkValidatorResults(BaseModel):
            ...
            warnings: int = 0
            errors: Annotated[
                MutableSequence[FlextQualityModels.Quality.LinkCheckResult],
                Field(
                    default_factory=list,
                ),
            ]
            warnings_list: Annotated[
                MutableSequence[FlextQualityModels.Quality.LinkCheckResult],
                Field(default_factory=list),
            ]
        ...
        class AlertThresholdConfig(BaseModel):
            ...
            enabled: bool = True
            threshold: Annotated[t.NonNegativeInt, Field(default=0)]
        ...
        class SeverityLevelsConfig(BaseModel):
            ...
            critical: Annotated[t.StrSequence, Field(default_factory=list)]
            high: Annotated[t.StrSequence, Field(default_factory=list)]
            medium: Annotated[t.StrSequence, Field(default_factory=list)]
            low: Annotated[t.StrSequence, Field(default_factory=list)]
