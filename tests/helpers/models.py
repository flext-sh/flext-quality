"""Test models extending flext_quality.models for test-specific functionality.

This module provides test-specific model classes that extend the production
models from src/flext_quality/models.py. All test models use real inheritance
