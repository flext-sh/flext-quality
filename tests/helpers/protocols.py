"""Test protocols extending flext_quality.protocols for test-specific protocols.

This module provides test-specific protocol definitions that extend the
production protocols from src/flext_quality/protocols.py. All test protocols
...
class TestsProtocols(FlextQualityProtocols):
    """Test-specific protocols extending FlextQualityProtocols.
