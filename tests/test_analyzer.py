...
class TestCodeAnalyzer:
    ...
    def test_analyzer_with_string_path(self, temp_project):
    ...
    def test_analyze_file_with_syntax_error(self, temp_project):
    ...
    def test_analyze_file_nonexistent(self, temp_project):
    ...
    def test_calculate_complexity(self, temp_project):
    ...
    def test_calculate_overall_metrics(self, temp_project):
    ...
    def test_calculate_overall_metrics_empty(self, temp_project):
    ...
    def test_analyze_security(self, temp_project):
    ...
    def test_analyze_complexity_issues(self, temp_project):
    ...
    def test_analyze_duplicates(self, temp_project):
    ...
    def test_full_project_analysis(self, temp_project):
    ...
    def test_selective_analysis(self, temp_project):
    ...
    def test_get_quality_score_no_analysis(self, temp_project):
        """Test quality score with no analysis results."""
        analyzer = CodeAnalyzer(temp_project)
        score = analyzer.get_quality_score()
        assert score == 0.0

    def test_get_quality_score_with_issues(self, temp_project):
    ...
    def test_get_quality_score_perfect(self, temp_project):
    ...
    def test_get_quality_grade(self, temp_project):
        ...
        for score, expected_grade in test_cases:
            ...
            analyzer.get_quality_score = lambda: score
    ...
    def test_analysis_results_storage(self, temp_project):
    ...
    def test_analyze_project_logging(self, temp_project, caplog):
    ...
    def test_file_analysis_error_handling(self, temp_project):
    ...
    def test_security_analysis_error_handling(self, temp_project, caplog):
    ...
    def test_dead_code_analysis_error_handling(self, temp_project, caplog):
    ...
    def test_duplicate_analysis_error_handling(self, temp_project, caplog):
