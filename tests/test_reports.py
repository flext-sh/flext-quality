...
class TestQualityReport:
    ...
    def test_report_initialization(self, minimal_results):
        """Test QualityReport initialization."""
        report = QualityReport(minimal_results)
        assert report.results == minimal_results

    def test_get_quality_score_minimal(self, minimal_results):
    ...
    def test_get_quality_score_with_issues(self, poor_results):
    ...
    def test_get_quality_grade_all_levels(self):
        ...
        for expected_grade, issues_setup in test_cases:
            ...
            if grade != expected_grade:
                print(f"Expected {expected_grade}, got {grade}, score: {score}")
    ...
    def test_get_grade_color(self):
        ...
        for expected_grade, issues_count in grade_tests:
            results = {
                "issues": {
    ...
    def test_get_total_issues(self, mixed_results):
    ...
    def test_get_critical_issues(self, mixed_results):
    ...
    def test_generate_text_report_with_issues(self, poor_results):
    ...
    def test_generate_text_report_issue_truncation(self, poor_results):
        ...
        assert "... and" in text_report and "more" in text_report

    def test_generate_json_report(self, good_results):
    ...
    def test_generate_html_report_structure(self, mixed_results):
    ...
    def test_generate_html_report_issues_section(self, mixed_results):
    ...
    def test_generate_html_report_colors(self):
    ...
    def test_generate_issues_html_empty(self, minimal_results):
    ...
    def test_generate_issues_html_with_issues(self, mixed_results):
    ...
    def test_generate_issues_html_truncation(self):
        ...
        # Should show truncation message
        assert "... and" in issues_html and "more issues" in issues_html

    def test_generate_recommendations_excellent_code(self, minimal_results):
    ...
    def test_generate_recommendations_critical_issues(self, mixed_results):
    ...
    def test_generate_recommendations_many_issues(self, poor_results):
    ...
    def test_save_report_text_format(self, good_results):
    ...
    def test_save_report_json_format(self, good_results):
    ...
    def test_save_report_html_format(self, good_results):
    ...
    def test_save_report_default_format(self, good_results):
    ...
    def test_edge_case_missing_issue_fields(self):
    ...
    def test_html_issue_severity_classes(self):
    ...
    def test_generate_html_with_line_numbers(self):
